...
def get_sce_detection_threshold_old_version(spike_nums, window_duration, n_surrogate, perc_threshold=95, non_binary=False,
    ...
    if spike_train_mode:
        ...
        for i, surrogate_train_list in enumerate(surrogate_data_set):
            ...
            if n_cells < 255:
                windows_sum = np.zeros((n_cells, n_times), dtype="uint8")
            else:
                windows_sum = np.zeros((n_cells, n_times), dtype="uint16")
            ...
            for cell, spikes_train in enumerate(spike_nums):
                ...
                for spike_time in spikes_train:
                    ...
                    first_index_window = spike_index - window_duration
